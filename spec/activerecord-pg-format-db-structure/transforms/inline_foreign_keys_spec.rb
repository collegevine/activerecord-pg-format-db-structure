...
RSpec.describe ActiveRecordPgFormatDbStructure::Transforms::InlineForeignKeys do
  describe "#transform!" do
    it "inline foreign key constraints in the table declaration" do
      ...
      expect(formatter.format(source)).to eq(<<~SQL.chomp)
        ...
        CREATE TABLE public.comments (
            id bigint NOT NULL,
            user_id bigint NOT NULL CONSTRAINT fk_rails_0000000002 REFERENCES public.users (id),
